...
const Hero = () => {
  ...
  return (
    <section className='min-w-[100vw] max-h-screen mt-16 px-4 sm:px-8 lg:px-20 flex flex-col lg:flex-row justify-between items-center overflow-hidden'>
      {/* Text Content */}
      <div className='flex flex-col justify-center w-full lg:flex-1'>
        ...
        <h1 id="hero-text" className='text-3xl md:text-5xl lg:text-6xl font-bold w-[100%] lg:min-h-[140px] poppins mt-6'>
          <span id="typed-text"></span>
          <span id="cursor" className='w-[2px] h-9 ml-1 md:h-[50px] lg:h-[70px] '></span>
        </h1>
        <p className='mt-3 text-sm md:text-base lg:text-base font-extralight montserrat'>
